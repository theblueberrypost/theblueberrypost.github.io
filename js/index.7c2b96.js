...
$(function(){
r=function(){if(thresholdPassed()){dpi=window.devicePixelRatio;if($(window).width()>=960){var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/img-1028-1398.jpg':'images/img-1028-699.jpg');}else{var e=document.querySelector('.js1');e.setAttribute('src',(dpi>1)?'images/img-1028-466.jpg':'images/img-1028-233.jpg');}}};
